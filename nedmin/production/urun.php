                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $urun->urun_stokkodu ?></td>
                                        <td><?php echo $urun->urun_stok ?></td>
                                        <td><?php echo $urun->urun_fiyat ?></td>
                                        <td><center><a href="urun-galeri.php?urun_id=<?php echo $urun->urun_id; ?> "><button class="btn btn-success btn-xs">Resim İşilemleri</button></a></center></td>
                                        <td>
                                            <center>
                                                <?php 
