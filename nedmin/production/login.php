...
<head>
    ...
    <title>Real Granit Evye – Evye Burada | Granit Eviye | En Uygun ve Kaliteli Evye Modelleri Burada |</title>
    <!-- Bootstrap -->
            ...
            <div class="animate form login_form">
                <section class="login_content">
                    <form action="../netting/islem.php" method="POST">
                        <h1>Login Form</h1>
                        <div>
                            <input type="text" name="kullanici_mail" class="form-control" placeholder="Kullanıcı Adınız (Mail)" />
                        </div>
                        <div>
                            <input type="password" name="kullanici_password" class="form-control" placeholder="Şifreniz" />
                        </div>
                        <div>
                        ...
                        <div class="separator">
                            ...
                            <br />
                            <div>
                                <h1><i class="fa fa-paw"></i> Osmanlı Sanayi</h1>
                                <p>©2022 Osmanlı Sanayi</p>
                            </div>
                        </div>
                    </form>
                </section>
