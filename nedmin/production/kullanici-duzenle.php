                        ...
                        <div class="x_title">
                            <h2>
                                <?php 
                                    if (isset($_GET['durum'])) {
                                        if ($_GET['durum']=="bos") {
                                            echo '<b style="color:red;">Lütfen boş alan bırakmayın...</b>';
                                        }elseif($_GET['durum']=="adsoyad") {
                                            echo '<b style="color:red;">İsminizi ve Soyisminizi doğru giriniz...</b>';
                                        }elseif($_GET['durum']=="pass") {
                                            echo '<b style="color:red;">Şİfreniz 6 karakterden büyük olmalıdır...</b>';
                                        }elseif($_GET['durum']=="tc1") {
                                            echo '<b style="color:red;">TC numaranız sadece rakamlardan oluşmalıdır...</b>';
                                        }
                                    }
                                ?>
                            </h2>
